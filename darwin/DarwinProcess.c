...
static void DarwinProcess_updateCmdLine(const struct kinfo_proc* k, Process* proc) {
   ...
   /* This function is from the old Mac version of hbottom. Originally from ps? */
...
void DarwinProcess_setFromKInfoProc(Process* proc, const struct kinfo_proc* ps, bool exists) {
   ...
   if (proc->tty_name == NULL && (dev_t)proc->tty_nr != NODEV) {
       ...
       * and represents ~95% of hbottom's CPU usage when there is high
       * process turnover.
       *
 ...
 * and       https://github.com/max-horvath/hbottom-osx/blob/e86692e869e30b0bc7264b3675d2a4014866ef46/ProcessList.c
 */
