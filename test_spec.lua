...
os.execute("rm -f coverage.info test.hbottomrc")
os.execute("rm -rf lcov")
os.execute("killall hbottom")
os.execute("ps aux | grep '[s]leep 12345' | awk '{print $2}' | xargs kill 2> /dev/null")

os.execute("cp ./default.hbottomrc ./test.hbottomrc")
rt:forkPty("LC_ALL=C hbottomRC=./test.hbottomrc ./hbottom 2> hbottom-valgrind.txt")
...
delay(2) -- give some time for hbottom to initialize.
rt:update()
...
describe("hbottom test suite", function()
