...
static hbottom_Reaction Platform_actionSetIOPriority(State* st) {
...
static hbottom_Reaction Platform_actionHigherAutogroupPriority(State* st) {
   if (Settings_isReadonly())
      return hbottom_OK;
...
static hbottom_Reaction Platform_actionLowerAutogroupPriority(State* st) {
   if (Settings_isReadonly())
      return hbottom_OK;
...
void Platform_setBindings(hbottom_Action* keys) {
